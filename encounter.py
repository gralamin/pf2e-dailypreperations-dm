...
ENCOUNTER_LOW_5_BANDIT = Encounter(
    MONSTER_BANDIT, MONSTER_BANDIT, MONSTER_BANDIT, MONSTER_BANDIT, MONSTER_BANDIT
)
ENCOUNTER_MOD_5_HYDRA = Encounter(MONSTER_HYDRA, MONSTER_HIERACOSPHINX)
ENCOUNTER_MOD_5_DRETCH = Encounter(
    MONSTER_DRETCH,
    MONSTER_DRETCH,
    MONSTER_WORM_DEMON,
    MONSTER_WORM_DEMON,
...
ENCOUNTER_MOD_5_MANTICORE = Encounter(
    MONSTER_MANTICORE_WEAK, MONSTER_MANTICORE_WEAK, MONSTER_MANTICORE_WEAK
)
ENCOUNTER_MOD_5_BANDITS = Encounter(
    MONSTER_BOAR,
    MONSTER_BOAR,
    MONSTER_BOAR,
    MONSTER_ELITE_BANDITS,
    MONSTER_ELITE_BANDITS,
    MONSTER_ELITE_BANDITS,
)
ENCOUNTER_MOD_5_PERYTON = Encounter(
    MONSTER_PERYTON, MONSTER_PERYTON, MONSTER_PERYTON, MONSTER_PERYTON, MONSTER_PERYTON
)
